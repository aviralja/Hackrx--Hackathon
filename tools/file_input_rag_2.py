...
#TODO: make it more dynamic CLI input or something
...
def store_chunks_in_chromadb(chunks, doc, collection_name="chunks"):
    ...
    for idx, text in enumerate(chunks, start=1):
        ...
        collection.upsert(
            ...
            ids=[f"{doc}_{idx}"], #TODO: make it more unique
            metadatas=[{
...
def process_pdf_data(pdf_paths):
    for idx, pdf_path in enumerate(pdf_paths):
        try:
            ...
            store_chunks_in_chromadb(chunks, doc_id)
